...
/** The `AppDetection` class is used to perform on-device app detection. It can return detected appIds, or perform additional API calls and return detected appDictionaries.
 
 *Requirements:* iOS base SDK 5.0+, Internet connectivity for app dictionary retrieval
  
 */
@interface AppDetection: NSObject
